 ...
 * Supports primary, secondary, danger variants with disabled and loading states
 */
...
const Button = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-400 disabled:hover:bg-gray-200',
